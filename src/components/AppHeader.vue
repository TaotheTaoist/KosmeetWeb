<template>
  <header
    ...
    :class="{
      'bg-gradient-to-r from-[#331541] via-[#1f112e] to-[#150f29] backdrop-blur-md shadow-lg':
  ...
  >
    <nav class="w-[94%] mx-auto">
      ...
      >
        <router-link
          to="/"
          class="flex items-center lg:space-x-2 md:space-x-1 space-x-1 cursor-pointer hover:opacity-90 transition-opacity"
        >
          <img
            src="/images/icons/app_icon.webp"
            alt="Kosmeet App Icon"
            class="lg:w-20 lg:h-20 md:w-16 md:h-16 w-20 h-20 object-contain"
          />
        ...
        <!-- Desktop Navigation -->
        <div
          class="hidden md:flex items-center lg:space-x-6 md:space-x-5 space-x-5 lg:ml-8 md:ml-4 text-secondary lg:text-2xl md:text-xl font-medium"
        >
        ...
        <div class="hidden md:flex items-center space-x-8">
          ...
          >
            <template #prefix>
              <svg
                class="w-8 h-8 transition-colors duration-300 #E0E0E0"
                fill="currentColor"
                viewBox="0 0 24 24"
              >
                <path
